	...
	public Map<String, Object> eliminar(String id) {
	    ...
	    try {
	        ...
	        if (optProveedor.isEmpty()) {
	            ...
	            String nuevoEstado = (proveedor.getEstado().equals("Disponible")) ? "No disponible" : "Disponible";
	            proveedorService.actualizarEstadoProveedor(Long.parseLong(id), nuevoEstado);
	            List<Proveedor> lista = proveedorService.listaProveedor();
	            salida.put("lista", lista);
