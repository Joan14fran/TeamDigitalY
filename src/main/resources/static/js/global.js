...
var MSG_CAMBIAR_ESTADO = "&#191;Desea cambiar el estado de este registro&#63;";
var MSG_ACTUALIZAR = "&#191;Desea cambiar el estado de este registro&#63;";
var MSG_ACTUALIZAR_ENTREADO = "!!Has click en aceptar para actualizar estado!!";
                      ...
                      '<div class="modal-dialog modal-confirm">'+
                          '<div class="modal-content">'+
                              ...
                              '<div class="modal-footer justify-content-center">'+
                                  '<button type="button" class="btn btn-success" id="id_btn_dialog_aceptar">Aceptar</button>'+
                              '</div>'+
                              '</div></div></div>');
	...
	$("body").append('<div id="id_my_modal_confirmacion" class="modal fade" role="dialog">'+
                     '<div class="modal-dialog modal-confirm">'+
                         '<div class="modal-content">'+
                             '<div class="modal-header flex-column">'+
                                 '<div class="icon-box">'+
                                     '<i class="material-icons">&quest;</i>'+
                                 '</div>'+
                                 '<h4 class="modal-title w-100">Mensaje</h4>'+
                                 '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>'+
                             '</div>'+
                             ...
                             '</div>'+
                             '<div class="modal-footer justify-content-center">'+
                                 '<button type="button" class="btn btn-primary" id="id_btn_dialog_no">Cancel</button>'+
                                 '<button type="button" class="btn btn-danger" id="id_btn_dialog_si">Aceptar</button>'+
                             '</div> </div> </div> </div>');
